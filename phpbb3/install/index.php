...
* @version $Id: index.php,v 1.1.1.1 2009/05/15 04:03:25 portalxl group Exp $
*
...
// At least include the portal special install language package
include($phpbb_root_path . 'language/' . $language . '/mods/portal_xl_install.' . $phpEx);
...
$template->set_filenames(array(
	'body' => 'portal_xl/portal_install.html')
);
