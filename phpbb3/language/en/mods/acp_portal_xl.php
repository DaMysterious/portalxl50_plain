...
*/
   ...
   'ACP_PORTAL_METATAGS_INFO_EXPLAIN'   			=> 'Welcome to the META Tags management. These tags will allow you to give a description of your website to the search engine.<br/ >This will allow the search engine to index your site better.<br/ >Furthermore, these tags allow other options such as automatic redirect to another URL.',
   'PORTAL_META_REDIRECT_URL_TIME'            		=> 'Redirection Time (sec)',
   'PORTAL_META_REDIRECT_URL_TIME_EXPLAIN'          => 'Specifies a delay in seconds before the browser automatically redirect the document to an URL specified. The number before the URL is the delay in seconds which the browser will "pause" before the redirect is performed. Leave blank for <strong>No</strong> automatically redirection!',
   'PORTAL_META_REDIRECT_URL_ADRESS'            	=> 'Redirection Adress (URL)',
   ...
   'PORTAL_META_REFRESH_EXPLAIN'        			=> 'Specifies a delay in seconds before the browser automatically reloads the document. The number is the delay in seconds which the browser will "pause" before the refresh is performed. Enter a number in seconds. Leave blank for <strong>No</strong> automatically refresh!',
   'PORTAL_META_PRAGMA'            					=> 'META Pragma',
   'PORTAL_META_PRAGMA_EXPLAIN'        				=> 'Prohibit the record of the page in the cache memory of the browser.<br/ >- To use this tag, enter <i>no-cache</i>, if not, left empty.',
   'PORTAL_META_KEYWORDS'            				=> 'META Keywords',
   'PORTAL_META_KEYWORDS_EXPLAIN'        			=> 'Function: Indicate to the search engines the key words related with your site.<br />- Maximum number of characters: 1000 or 100 key words.<br/ >- In the number of characters, do not forget to count the <a href="accent.htm">accentuated letters</a> once coded in HTML. For example the letter "à", coded &amp&agrave; in HTML counts for eight characters.<br />- You should not repeat several times the same key word (the search engines do not like it).<br />- The key words are separate by a comma, a space or a comma and a space, it is your choice.',
   'PORTAL_META_DESCRIPTION'            			=> 'META Description',
   'PORTAL_META_DESCRIPTION_EXPLAIN'        		=> 'Description of your site.<br />- Maximum number of characters: 200<br />- Avoid the accents, on certain engines they are not taken into account.',
   'PORTAL_META_AUTHOR'            					=> 'META Author',
   'PORTAL_META_AUTHOR_EXPLAIN'        				=> 'Allows identification of the site author.<br/ >- Put the first name into tiny, followed by the family name in capital letter.<br/ >- If you wish, you can put several authors separated by a comma.',
   'PORTAL_META_IDENTIFIER_URL'            			=> 'META Identifier-url',
   'PORTAL_META_IDENTIFIER_URL_EXPLAIN'        		=> 'Makes possible to specify the URL.<br />- Enter the URL of your home page.<br />- You must specify only one URL.',
   'PORTAL_META_REPLY_TO'            				=> 'META Reply-to',
   'PORTAL_META_REPLY_TO_EXPLAIN'        			=> 'Allows to specify the email of the webmaster.<br/ > It is preferable to put only one address.',
   'PORTAL_META_REVISIT_AFTER'            			=> 'META Revisit-after',
   'PORTAL_META_REVISIT_AFTER_EXPLAIN'        		=> 'Allows you to specafiy the number of days before the spider (robot of the engine) will index your site. - 15 days" or "30 days" are the best options.',
   'PORTAL_META_CATEGORY'            				=> 'META Category',
   'PORTAL_META_CATEGORY_EXPLAIN'        			=> 'Allows to specify the category of your site. Used by certain engines which give a classification by category.',
   'PORTAL_META_COPYRIGHT'            				=> 'META Copyright',
   'PORTAL_META_COPYRIGHT_EXPLAIN'        			=> 'Typically an unqualified copyright statement.<br /> - You can include copyright, trademarks, patents, or other information here pertaining to your intellectual property.',
   'PORTAL_META_GENERATOR'            				=> 'META Generator',
   'PORTAL_META_GENERATOR_EXPLAIN'        			=> 'Typically the name and version number of a publishing tool used to create the page.<br/ >- Could be used by tool vendors to assess market penetration. <br / >- Same tags as meta publisher.',
   'PORTAL_META_ROBOTS'            					=> 'META Robots',
   'PORTAL_META_ROBOTS_EXPLAIN'        				=> 'Controls search engine robots on a per-page basis.<br/ >- <strong>all</strong> = The bot index all the site (by default)<br />- <strong>none</strong> = The bot do not index your site at all<br />- <strong>index</strong> = your page is indexed<br />- <strong>noindex</strong> = Your page is\'nt indexed but the bot will follow the link of your page<br />- <strong>follow</strong> = The bot take note of your the link on your page for indexing them after.<br />- <strong>nofollow</strong> = The bot do not index the link on your page.<br />- <strong>noodp</strong> = Opting Out of Open Directory Listings for Webmasters (Live Search Microsoft). This tells the MSN search bot not to use the DMOZ site snippet, only MSN ignores ODP content for your page.',
   'PORTAL_META_DISTRIBUTION'            			=> 'META Distribution',
   'PORTAL_META_DISTRIBUTION_EXPLAIN'        		=> 'There are three classifications of distribution of your web content:<br/ >- <strong>Global</strong> (the entire web)<br/ >- <strong>Local</strong> (reserved for the local IP block of your site)<br/ >- <strong>IU</strong> (Internal Use, not for public distribution).',
   'PORTAL_META_CREATION_YEAR'            			=> 'META Date-creation-yyyy',
   'PORTAL_META_CREATION_YEAR_EXPLAIN'        		=> 'Creation year of your site eg. 2005.',
   'PORTAL_META_CREATION_MONTH'            			=> 'META Date-creation-mm',
   'PORTAL_META_CREATION_MONTH_EXPLAIN'        		=> 'Creation month of your site eg. 03.',
   'PORTAL_META_CREATION_DAY'            			=> 'META Date-creation-dd',
   'PORTAL_META_CREATION_DAY_EXPLAIN'        		=> 'Creation day of your site eg. 23.',
   'PORTAL_META_REVISION_YEAR'            			=> 'META Date-revision-yyyy',
   'PORTAL_META_REVISION_YEAR_EXPLAIN'        		=> 'Creation year of your site eg. 2007.',
   'PORTAL_META_REVISION_MONTH'            			=> 'META Date-revision-mm',
   'PORTAL_META_REVISION_MONTH_EXPLAIN'        		=> 'Creation month of your site eg. 08.',
   'PORTAL_META_REVISION_DAY'            			=> 'META Date-revision-dd',
   'PORTAL_META_REVISION_DAY_EXPLAIN'        		=> 'Creation day of your site eg. 21.',
