...
/*
*
* @name poll_simple.php
* @package phpBB3 Portal XL 5.0
* @version $Id: poll_simple.php,v 1.3 2010/10/31 portalxl group Exp $
*
...
// Initial var setup
$forum_id	= request_var('f', $portal_config['portal_poll_forum_id']);
$topic_id	= request_var('t', $portal_config['portal_poll_topic_id']);
$post_id	= request_var('p', $portal_config['portal_poll_post_id']);
...
if (!$topic_id && !$post_id)
{
	...
	$portal_config['portal_poll_topic_id'] = false; 
}
...
$template->set_filenames(array(
    'body' => 'portal/block/poll_simple.html',
	));
