...
/*
*
* @name index_blocks.php
* @package phpBB3 Portal XL 5.0
* @version $Id: index_blocks.php,v 1.2 2009/05/15 22:32:09 portalxl group Exp $
*
...
global $phpbb_root_path, $phpEx, $config, $portal_config;
	...
	*/
	...
	{
		if (preg_match('#([^.]+)\.#', $row_portal_blocks['block_name'], $indexMatch))
		if (file_exists($phpbb_root_path . 'portal/block/'.$indexMatch[1].'.'.$phpEx))
		include_once($phpbb_root_path . 'portal/block/'.$indexMatch[1].'.'.$phpEx);
	}
	$db->sql_freeresult($result);
