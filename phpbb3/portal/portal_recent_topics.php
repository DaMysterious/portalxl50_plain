...
* @version $Id: portal_recent_topics.php,v 1.3 2009/06/03 22:06:43 portalxl group Exp $
*
...
global $user, $portal_config, $config, $db, $auth, $template, $forums, $forum_data, $post_alt, $topic_data, $time;
