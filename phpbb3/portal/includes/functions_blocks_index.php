...
* @version $Id: functions_blocks_index.php,v 1.2 2009/05/15 22:32:09 portalxl group Exp $
*
...
*/
function index_block_template($info)
{
		global $template;
		...
		*/
		...
		if($top_block_name !='') 
		{
			...
			$template->assign_block_vars('top_block_files', array(
				'TOP_BLOCKS'      		=> index_block_template($value),
		...
		if($left_block_name !='') 
		{
			...
			$template->assign_block_vars('left_block_files', array(
				'LEFT_BLOCKS'       	=> index_block_template($value),
		...
		if($center_block_name !='') 
		{
		    ...
		    $template->assign_block_vars('center_block_files', array(
		        'CENTER_BLOCKS'      	=> index_block_template($value),
		...
		if($right_block_name !='') 
		{
			...
			$template->assign_block_vars('right_block_files', array(
				'RIGHT_BLOCKS'      	=> index_block_template($value),
		...
		if ($bottom_block_name !='') 
		{
			...
			$template->assign_block_vars('bottom_block_files', array(
				'BOTTOM_BLOCKS'   		=> index_block_template($value),
