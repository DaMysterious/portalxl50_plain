...
* @version $Id: portal_xl_install.php,v 1.2 2009/10/20 portalxl group Exp $
...
$lang = array_merge($lang, array(
	...
	<ul>
		...
		<strong><span style="color:#009900;">CHMOD <span style="color:#FF0000;">666</span> into</span></strong>:<br />
		/images/counter/ip.txt<br /><br />
		<strong><span style="color:#009900;">CHMOD <span style="color:#FF0000;">777</span> into</span></strong>:<br />
		/cache<br />
		/store<br />
		/files<br />
		/images/avatars/upload<br />
	...
	<ul>
		...
		/images/counter/ip.txt<br /><br />
		<strong><span style="color:#009900;">BBCODE <span style="color:#FF0000;">777</span> into</span></strong>:<br />
		/cache<br />
		/store<br />
		/files<br />
		/images/avatars/upload<br />
